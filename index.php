...
<html lang="ru">
	...
	<body>
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav" id="scroll-menu">
							...
							<li>
								...
								data-target=".bs-example-modal-lg">КОНСУЛЬТАЦИЯ</button>
							</li>
						</ul>
					</div>
				</div>
		...
		<section class="section section--right section--portraits" id="secion-main">
			...
			data-wow-duration="3.5s">Ларькина Наталья Юрьевна практикующий педагог-психолог
				<br>с 2006 - 2011, 2015 - доцент кафедры
				<br>психология и педагогика детсва ИПиП ТюмГУ
				<br>кандидат биологических наук</p>
		...
		<section id="mission">
			 <h1 class="wow fadeInDown" id="my_mission" data-wow-delay="200ms" data-wow-duration="3.5s">Моя МИССИЯ</h1>

			 <h1 class="wow fadeInDown" id="my_mission_text" data-wow-delay="100ms"
			data-wow-duration="2.5s">Возрождение психологической службы города Тюмени</h1>
			...
			<div class="grid">
				<figure class="effect-romeo">
					...
					<figcaption>
						...
						<p>Публичные выступления</p><a href="http://bit.ly/2oByhH3" target="blank">View more</a>
