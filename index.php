...
<html lang="ru">
	...
	<body>
			...
			data-wow-delay="100ms" id="top-menu">
				<div class="container">
					<div class="navbar-header">
						...
						<div class="tel-to-call hidden-sm"><a href="tel:+79129216022" id="tel-call-id">	</a>
						</div>
					</div>
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav" id="scroll-menu">
							...
							<li>
								<button class="btn btn-primary center-block visible-sm visible-xs" data-toggle="modal"
		...
		<section class="section section--right section--portraits" id="section-main">
			 <h1 class="section__heading wow fadeInDown" data-wow-delay="100ms" data-wow-duration="3.5s"></h1>

			<p class="section__subtitle wow bounceInRight" data-wow-delay="200ms"
			data-wow-duration="3.5s"></p>
		...
		<section class="interval" id="grid">
			<div class="grid">
				<figure class="effect-layla" id="grid-effect-layla1">
					<img src="assets/img/basic/inter-1.jpg" alt="inter-1">
					<figcaption></figcaption>
				</figure>
				<figure class="effect-layla" id="grid-effect-layla2">
					<img src="assets/img/basic/inter-2.jpg" alt="inter-2">
					<figcaption></figcaption>
				</figure>
			</div>
		</section>
		<section class="hidden-xs" id="video-slide">
			<div class="sl">
		...
		<section id="mission">
			 <h1 class="wow fadeInDown" id="my_mission" data-wow-delay="200ms" data-wow-duration="3.5s"> </h1>

			 <h1 class="wow fadeInDown" id="my_mission_text" data-wow-delay="100ms"
			data-wow-duration="2.5s"> </h1>
			...
			<div class="button button-order visible-md visible-lg">
				...
				<div class="modal-content">
					<div class="background">
						<div class="modal-header">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="teacher_problem">
								...
								<div class="tab-pane" id="system_assessment">
									<iframe src="//www.slideshare.net/slideshow/embed_code/key/u7mlAdxTdSgAZX"
									width="100%" height="500" style="height: 85vh;">SYSTEM ASSESSMENT OF MORPHOFUNCTIONAL DEVELOPMENT</iframe>
								</div>
							</div>
						</div>
					</div>
